...
@Component({
    ...
    export class ConsultaComponent implements OnInit {
        ...
        /**EXCLUIR UM REGISTRO QUANDO CLICAMOS NA OPÇÃO EXCLUIR DE UMA LINHA DA TABELA */
        excluir(codigo:number, index:number):void {
            ...
            if(confirm("Deseja realmente excluir esse registro?")){
                ...
                this.pessoaService.excluirPessoa(codigo).subscribe(response => {
                    ...
                    /**1 = SUCESSO
                     * MOSTRAMOS A MENSAGEM RETORNADA PELO SERVIÇO E DEPOIS REMOVEMOS O REGISTRO DA TABELA HTML */
                    if(res.codigo == 1){
                        alert(res.mensagem);
